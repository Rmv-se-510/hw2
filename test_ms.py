...
def test_large_array():
    ...
    assert mergeSort(large_array) == sorted(large_array)
...
def test_array_with_duplicates():
    ...
    assert mergeSort(array_with_duplicates) == sorted(array_with_duplicates)
...
def test_negative_numbers():
    ...
    assert mergeSort(array_with_negatives) == sorted(array_with_negatives)
...
def test_mixed_positive_negative():
    ...
    assert mergeSort(mixed_array) == sorted(mixed_array)
...
def test_floats_and_integers():
    ...
    assert mergeSort(mixed_float_int_array) == sorted(mixed_float_int_array)
