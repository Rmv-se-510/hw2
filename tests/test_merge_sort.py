...
def test_large_array():
    ...
    assert merge_sort(large_array) == sorted(large_array)
...
def test_array_with_duplicates():
    ...
    assert merge_sort(array_with_duplicates) == sorted(array_with_duplicates)
...
def test_negative_numbers():
    ...
    assert merge_sort(array_with_negatives) == sorted(array_with_negatives)
...
def test_mixed_positive_negative():
    ...
    assert merge_sort(mixed_array) == sorted(mixed_array)
...
def test_floats_and_integers():
    ...
    assert merge_sort(mixed_float_int_array) == sorted(mixed_float_int_array)
