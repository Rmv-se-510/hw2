import warnings
import pytest
from hw2_debugging import selectionSort
...
def test_large_array():
    ...
    assert selectionSort(large_array) == sorted(large_array)
...
def test_array_with_duplicates():
    ...
    assert selectionSort(array_with_duplicates) == sorted(array_with_duplicates)
...
def test_negative_numbers():
    ...
    assert selectionSort(array_with_negatives) == sorted(array_with_negatives)
...
def test_mixed_positive_negative():
    ...
    assert selectionSort(mixed_array) == sorted(mixed_array)
...
def test_floats_and_integers():
    ...
    assert selectionSort(mixed_float_int_array) == sorted(mixed_float_int_array)